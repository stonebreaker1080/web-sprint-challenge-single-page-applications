...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    It's used to enable nested routes
1. How would you explain form validation to someone who has never programmed before?
    I ask the computer to check what you entered into the form against criteria i provided previously
1. In 1-2 sentences, define end to end testing.
    A testing environment is created to simulate the entire user experience to check for errors and bad behavior
